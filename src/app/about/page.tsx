...
export const metadata: Metadata = { title: "About Our Tattoo Studio", description: "Meet Ahmedabad Ink Tattoo, a custom tattoo studio built on original design, careful craft and uncompromising hygiene since 2014.", alternates: { canonical: "/about" } };
